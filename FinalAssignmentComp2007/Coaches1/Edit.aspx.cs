...
namespace FinalAssignmentComp2007.Coaches1
{
    public partial class Edit : System.Web.UI.Page
    {
        ...
        // This is the Update methd to update the selected Coaches item
        // USAGE: <asp:FormView UpdateMethod="UpdateItem">
        public void UpdateItem(int  Id)
        {
            using (_db)
            {
                var item = _db.Coaches1.Find(Id);
        ...
        // This is the Select method to selects a single Coaches item with the id
